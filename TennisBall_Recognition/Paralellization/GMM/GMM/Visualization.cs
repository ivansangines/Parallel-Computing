...
namespace GMM
{
    class Visualization
    {
        public static bool DrawPoints(PictureBox pan, List<MyPoint> PList, double scale)
        {
            ...
            {
                Point p = new Point((int)PList[i].X,(int)PList[i].Y);
        ...
        public static bool DrawClusters(PictureBox pan, List<MyPoint> PList, int clusterCount, double scale = 0.7)
        {
            // set cluster colors
