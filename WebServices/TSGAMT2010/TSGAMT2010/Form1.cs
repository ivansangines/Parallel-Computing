...
namespace TSGAMT2010
{
    ...
    {
        //-----------for the WCF----------
        int bestPath = 10000; //This will be the starting cost of the path
        string currentPath; //this will path description used as path id
        TSGAClient tsgaClient = new TSGAClient();
        List<TSGAClient> listClients = new List<TSGAClient>(); //will contain the list of clients subscribed
        //--------------------------------------------------
        ...
        private void btnRunGA_Click(object sender, EventArgs e)
        {
            ...
            tsgaClient.SubscribeToResultChange(bestPath, "myPath");
        ...
        private void btnStartThreads_Click(object sender, EventArgs e)
        {
            ...
            if (opt2.Checked == true)
            {
                ...
                {
                    listClients.Add(new TSGAClient());
                }
            }
            ...
            //Subscribe all clients to the resultChange
            for (int i = 0; i < listClients.Count; i++)
            {
                listClients[i].SubscribeToResultChange(10000, "myPath");
            }
        ...
        private void btnStartThreadsXchg_Click(object sender, EventArgs e)
        {
            ...
            //Subscribe all clients to the resultChange
            for (int t = 0; t < listClients.Count; t++)
            {
                listClients[i].SubscribeToResultChange(10000, "myPath");
            }
            //-----------------------------------------------
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                tsgaClient.UnSubscribeToResultChange();
                for (int i = 0; i < listClients.Count; i++)
                {
                    listClients.ElementAt(i).UnSubscribeToResultChange();
                }
